...
const addIslandToMap = (map: MapArray, islandMap: MapArray) => {
...
const generateValidMap = (
  ...
  while (true) {
    const islandMap = generateIslandMap(
      mapWidth,
      mapHeight,
      amountIslands,
      clusterSpread,
...
const mergeLayers = (mapToMerge: MapArray): MapArray => {
